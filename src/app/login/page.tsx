...
export default function LoginPage() {
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-gradient-to-b from-navy-900 to-navy-800 px-4">
      <HighwayScene className="pointer-events-none absolute inset-0 h-full w-full" />
